...
class CoursePriceListSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $courses = [
            ...
            ['name' => 'Weekend Program (Auto & Manual) 4 Weekends', 'schedule' => 'weekend', 'duration_weeks' => 4, 'duration_hours' => 32, 'fee' => 125000, 'tier' => 'weekend'],
            ['name' => 'Weekend Program (Auto & Manual) 4 Weekends (AC)', 'schedule' => 'weekend', 'duration_weeks' => 4, 'duration_hours' => 32, 'fee' => 155000, 'tier' => 'weekend'],
            ['name' => 'Executive Program with AC 3 Weeks', 'schedule' => 'weekday', 'duration_weeks' => 3, 'duration_hours' => 60, 'fee' => 155000, 'tier' => 'executive'],
            ['name' => 'Executive Training without AC 3 Weeks', 'schedule' => 'weekday', 'duration_weeks' => 3, 'duration_hours' => 60, 'fee' => 125000, 'tier' => 'executive'],
            ['name' => 'Executive Training without AC 4 Weeks', 'schedule' => 'weekday', 'duration_weeks' => 4, 'duration_hours' => 80, 'fee' => 155000, 'tier' => 'executive'],
            ['name' => 'VIP Program (Personal Car) 3 Weeks', 'schedule' => 'weekday', 'duration_weeks' => 3, 'duration_hours' => 60, 'fee' => 125000, 'tier' => 'vip'],
