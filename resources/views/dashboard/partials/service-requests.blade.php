...
<div class="bg-white shadow-sm ring-1 ring-gray-200 rounded-xl overflow-hidden mt-6">
    ...
    <a href="{{ route('service-reports.index', $requests->first()->service) }}" class="mx-8 flex flex-wrap items-center gap-x-8 gap-y-1 rounded-xl bg-amber-50/60 hover:bg-amber-100 transition px-5 py-3 text-xs font-semibold uppercase tracking-wider text-amber-800">
