            ...
            <div class="p-6 bg-white shadow sm:rounded-lg border-2 border-dashed border-gray-300 print:border-0 print:shadow-none">
                ...
                <dl class="divide-y divide-gray-100">
                    ...
                    <div class="py-2 grid grid-cols-2 gap-4">
                        ...
                        <dd class="text-sm text-gray-900 font-mono">{{ $ticket->student->student_id_number }}</dd>
                    </div>
                    <div class="py-2 grid grid-cols-2 gap-4">
                    ...
                    <div class="py-2 grid grid-cols-2 gap-4">
                        <dt class="text-sm font-medium text-gray-500">{{ __('Vehicle Number') }}</dt>
                        <dd class="text-sm text-gray-900">{{ $ticket->vehicle_number ?? '—' }}</dd>
                    </div>
                    <div class="py-2 grid grid-cols-2 gap-4">
