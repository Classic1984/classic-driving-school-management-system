...
>
    ...
    <ul x-show="open" x-cloak class="absolute z-10 mt-1 max-h-48 w-full overflow-auto rounded-md bg-white py-1 text-sm shadow-lg ring-1 ring-gray-200">
        ...
        <li x-show="options.length === 0" class="px-3 py-2 text-gray-400 italic">
        ...
        <li x-show="options.length > 0 && filtered.length === 0" class="px-3 py-2 text-gray-400 italic">{{ __('No matches - your typed value will still be used.') }}</li>
    </ul>
</div>
