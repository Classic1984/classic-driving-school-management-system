    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="flex items-center gap-4 mb-6 px-4 sm:px-0">
                ...
                <div>
                    <h3 class="text-2xl font-extrabold text-gray-900">{{ __('Register Instructor') }}</h3>
                    <p class="text-sm text-gray-500">{{ __('Add a new instructor to the team') }}</p>
                </div>
            </div>
