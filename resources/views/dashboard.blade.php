    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @php
                $heroCards = [
                    [
                        'title' => 'Total Students', 'value' => number_format($stats['students']),
                    ...
                    [
                        'title' => 'Training Today', 'value' => number_format($kpis['training_today']),
                        'icon' => 'M4.26 10.147a60.436 60.436 0 0 0-.491 6.347A48.627 48.627 0 0 1 12 20.904a48.627 48.627 0 0 1 8.232-4.41 60.46 60.46 0 0 0-.491-6.347m-15.482 0a50.57 50.57 0 0 0-2.658-.813A59.905 59.905 0 0 1 12 3.493a59.902 59.902 0 0 1 10.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.697 50.697 0 0 1 12 13.489a50.702 50.702 0 0 1 7.74-3.342M6.75 15a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Zm0 0v-3.675A55.378 55.378 0 0 1 12 8.443m-7.007 11.55A5.981 5.981 0 0 0 6.75 15.75v-1.5',
                    ...
                    [
                        'title' => 'Certificates Issued', 'value' => number_format($stats['certificates']),
                        'icon' => 'M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285Z',
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                @foreach ($heroCards as $card)
                    ...
                    <{{ $heroTag }}
                        ...
                        class="relative overflow-hidden rounded-xl bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white p-5 text-left shadow-sm transition hover:brightness-125"
                    >
                        <div class="flex items-start justify-between">
                            ...
                            <svg class="h-5 w-5 text-amber-400/60" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" /></svg>
                        </div>
                        <p class="mt-4 text-sm font-medium text-gray-300">{{ __($card['title']) }}</p>
                        <p class="text-3xl font-extrabold tabular-nums text-amber-400">{{ $card['value'] }}</p>
                        <p class="mt-2 text-xs text-gray-400">{{ $card['sub'] }}</p>
                    </{{ $heroTag }}>
                @endforeach
            </div>
                ...
                @php
                    ...
                    $summaryGroups = [
                        [
                            ...
                            'icon' => 'M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m.94 3.198.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0 1 12 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 0 1 6 18.719m12 0a5.971 5.971 0 0 0-.941-3.197m0 0A5.995 5.995 0 0 0 12 12.75a5.995 5.995 0 0 0-5.058 2.772m0 0a3 3 0 0 0-4.681 2.72 8.986 8.986 0 0 0 3.74.477m.94-3.197a5.971 5.971 0 0 0-.94 3.197M15 6.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm6 3a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Zm-13.5 0a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Z',
                            'rows' => [
                                ['label' => 'Active / Registered Students', 'value' => number_format($stats['students']), 'href' => route('students.index'), 'color' => 'blue', 'icon' => 'M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m.94 3.198.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0 1 12 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 0 1 6 18.719m12 0a5.971 5.971 0 0 0-.941-3.197m0 0A5.995 5.995 0 0 0 12 12.75a5.995 5.995 0 0 0-5.058 2.772m0 0a3 3 0 0 0-4.681 2.72 8.986 8.986 0 0 0 3.74.477m.94-3.197a5.971 5.971 0 0 0-.94 3.197M15 6.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm6 3a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Zm-13.5 0a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Z'],
                                ['label' => 'In a Program', 'value' => number_format($stats['students_in_program']), 'href' => route('enrolled-trainees.index'), 'color' => 'green', 'icon' => 'M4.26 10.147a60.436 60.436 0 0 0-.491 6.347A48.627 48.627 0 0 1 12 20.904a48.627 48.627 0 0 1 8.232-4.41 60.46 60.46 0 0 0-.491-6.347m-15.482 0a50.57 50.57 0 0 0-2.658-.813A59.905 59.905 0 0 1 12 3.493a59.902 59.902 0 0 1 10.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.697 50.697 0 0 1 12 13.489a50.702 50.702 0 0 1 7.74-3.342M6.75 15a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Zm0 0v-3.675A55.378 55.378 0 0 1 12 8.443m-7.007 11.55A5.981 5.981 0 0 0 6.75 15.75v-1.5'],
                                ['label' => 'Walk-in Services Only', 'value' => number_format($stats['students_walkin_only']), 'href' => route('students.index', ['enrollment' => 'walkin']), 'color' => 'teal', 'icon' => 'M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 0 0 .75-.75 2.25 2.25 0 0 0-.1-.664m-5.8 0A2.251 2.251 0 0 1 13.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25Z'],
                                ['label' => 'New This Month', 'value' => number_format($newStudentTotals['month']), 'href' => route('student-registration-report.index', ['period' => 'month']), 'color' => 'purple', 'icon' => 'M12 4.5v15m7.5-7.5h-15'],
                                ['label' => 'At-Risk Students', 'value' => number_format($kpis['at_risk_students']), 'modal' => 'at_risk_students-modal', 'color' => 'red', 'icon' => 'M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z'],
                                ['label' => 'Eligible for Upgrade', 'value' => number_format($upgradeEligible->count()), 'modal' => 'upgrade-eligible-modal', 'color' => 'pink', 'icon' => 'M8.25 6.75 12 3m0 0 3.75 3.75M12 3v18'],
                                ['label' => 'Upgrade Window Closed', 'value' => number_format($upgradeClosed->count()), 'modal' => 'upgrade-closed-modal', 'color' => 'gray', 'icon' => 'M15 12H9m12 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z'],
                                // Director-only, same as the Approval Centre
                                // link itself and the matching tile further
                                // down in Today's Operations - a secretary
                                // has no route to view or act on these.
                                ...(auth()->user()->isDirector() ? [
                                    ['label' => 'Pending Approvals', 'value' => number_format($todaysOperations['pending_approvals']), 'href' => route('approvals.index'), 'color' => 'red', 'icon' => 'M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285Z'],
                                ] : []),
                            ],
                        ],
                        [
                            ...
                            'rows' => [
                                ...
                                ['label' => 'Students Trained Today', 'value' => number_format($kpis['training_today']), 'modal' => 'training_today-modal', 'color' => 'green', 'icon' => 'M4.26 10.147a60.436 60.436 0 0 0-.491 6.347A48.627 48.627 0 0 1 12 20.904a48.627 48.627 0 0 1 8.232-4.41 60.46 60.46 0 0 0-.491-6.347m-15.482 0a50.57 50.57 0 0 0-2.658-.813A59.905 59.905 0 0 1 12 3.493a59.902 59.902 0 0 1 10.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.697 50.697 0 0 1 12 13.489a50.702 50.702 0 0 1 7.74-3.342M6.75 15a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Zm0 0v-3.675A55.378 55.378 0 0 1 12 8.443m-7.007 11.55A5.981 5.981 0 0 0 6.75 15.75v-1.5'],
                                ['label' => 'Active Vehicles', 'value' => number_format($kpis['active_vehicles']), 'modal' => 'active_vehicles-modal', 'color' => 'teal', 'icon' => 'M8.25 18.75a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 0 1-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 0 0-3.213-9.193 2.056 2.056 0 0 0-1.58-.86H14.25M16.5 18.75h-2.25m0-11.177v-.958c0-.568-.422-1.048-.987-1.106a48.554 48.554 0 0 0-10.026 0 1.106 1.106 0 0 0-.987 1.106v7.635m12-6.677v6.677m0 0h-12'],
                                ['label' => 'Vehicle(s) In Use Today', 'value' => number_format($todaysOperations['vehicles_in_use']), 'href' => route('vehicles.index'), 'color' => 'teal', 'icon' => 'M8.25 18.75a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 0 1-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 0 0-3.213-9.193 2.056 2.056 0 0 0-1.58-.86H14.25M16.5 18.75h-2.25m0-11.177v-.958c0-.568-.422-1.048-.987-1.106a48.554 48.554 0 0 0-10.026 0 1.106 1.106 0 0 0-.987 1.106v7.635m12-6.677v6.677m0 0h-12'],
                                ['label' => 'Active Instructors', 'value' => number_format($stats['instructors']), 'href' => route('instructors.index'), 'color' => 'gray', 'icon' => 'M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 22.5c-2.676 0-5.216-.584-7.499-1.632Z'],
                                ['label' => 'Completed Training', 'value' => number_format($kpis['completed_training']), 'modal' => 'completed_training-modal', 'color' => 'green', 'icon' => 'M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285Z'],
                                ...
                                ['label' => 'Absent Today', 'value' => number_format($absentToday->count()), 'modal' => 'absent-today-modal', 'color' => 'red', 'icon' => 'M9.75 9.75l4.5 4.5m0-4.5-4.5 4.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z'],
                                ['label' => 'Absent This Week', 'value' => number_format($absenceStats['week']), 'href' => route('absence-report.index', ['period' => 'week']), 'color' => 'amber', 'icon' => 'M9.75 9.75l4.5 4.5m0-4.5-4.5 4.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z'],
                                ['label' => 'Absent This Month', 'value' => number_format($absenceStats['month']), 'href' => route('absence-report.index', ['period' => 'month']), 'color' => 'orange', 'icon' => 'M9.75 9.75l4.5 4.5m0-4.5-4.5 4.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z'],
                                ['label' => 'Absent This Year', 'value' => number_format($absenceStats['year']), 'href' => route('absence-report.index', ['period' => 'year']), 'color' => 'red', 'icon' => 'M9.75 9.75l4.5 4.5m0-4.5-4.5 4.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z'],
                            ],
                        ],
                        [
                        ...
                        [
                            ...
                            'icon' => 'M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285Z',
                            'rows' => [
                                ['label' => 'Certificates Issued', 'value' => number_format($stats['certificates']), 'href' => route('certificates.index'), 'color' => 'blue', 'icon' => 'M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285Z'],
                                ['label' => 'Certificates Due', 'value' => number_format($kpis['certificates_due']), 'modal' => 'certificates_due-modal', 'color' => 'amber', 'icon' => 'M15 9h3.75M15 12h3.75M15 15h3.75M4.5 19.5h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Zm6.75-10.5a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Zm-4.5 4.5a4.5 4.5 0 0 1 4.5 0'],
                                ['label' => "Learner's Permit Pending", 'value' => number_format(max(0, $learnersPermitStats['charged'] - $learnersPermitStats['completed'])), 'href' => '#learners-permit-requests', 'color' => 'indigo', 'icon' => 'M15 9h3.75M15 12h3.75M15 15h3.75M4.5 19.5h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Zm6.75-10.5a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Zm-4.5 4.5a4.5 4.5 0 0 1 4.5 0'],
                                ['label' => "Driver's License Pending", 'value' => number_format(max(0, $driversLicenseStats['charged'] - $driversLicenseStats['completed'])), 'href' => '#drivers-license-requests', 'color' => 'teal', 'icon' => 'M8.25 18.75a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 0 1-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 0 0-3.213-9.193 2.056 2.056 0 0 0-1.58-.86H14.25M16.5 18.75h-2.25m0-11.177v-.958c0-.568-.422-1.048-.987-1.106a48.554 48.554 0 0 0-10.026 0 1.106 1.106 0 0 0-.987 1.106v7.635m12-6.677v6.677m0 0h-12'],
                            ],
                        ],
                    ];
            ...
            <div class="bg-black text-white rounded-xl p-8 mb-6">
                <div class="flex flex-wrap items-start justify-between gap-4 border-b border-white/10 pb-5">
                    ...
                    >
                        ...
                        <span x-text="dateLabel">{{ now()->format('l, M j, Y') }}</span>
            ...
            @if ($showUpcomingPaymentsCard || $lockedEnrollments->isNotEmpty())
                ...
                @endphp
                <div id="outstanding-payments" class="relative overflow-hidden rounded-xl bg-black p-6 sm:p-8 mt-6">
                    <svg class="pointer-events-none absolute -right-8 -top-8 h-48 w-48 text-amber-500/10" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="0.75"><path stroke-linecap="round" stroke-linejoin="round" d="{{ $walletIconPath }}" /></svg>
                    ...
                    <div class="relative flex items-center gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-white">{{ __('Outstanding Payments') }}</h3>
                            <p class="text-sm text-gray-400">{{ __('Students with upcoming payments due.') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="relative grid grid-cols-1 {{ $showUpcomingPaymentsCard && $lockedEnrollments->isNotEmpty() ? 'sm:grid-cols-2' : '' }} gap-4 mt-6">
                        @if ($showUpcomingPaymentsCard)
                            <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-amber-500/15 via-gray-900 to-gray-900 ring-1 ring-amber-400/30 p-6">
                                ...
                                <div class="relative">
                                    <p class="text-xs font-bold uppercase tracking-widest text-amber-400">{{ __('Upcoming') }}</p>
                                    <p class="mt-2 text-4xl font-extrabold text-amber-400">{{ $upcomingPayments->count() }}</p>
                                    <p class="mt-1 text-sm text-gray-300">{{ trans_choice('{1} student with payment due soon|[2,*] :count students with payment due soon', $upcomingPayments->count(), ['count' => $upcomingPayments->count()]) }}</p>
                                    <button type="button" x-data x-on:click="$dispatch('open-modal', 'upcoming-payments-modal')" class="mt-4 inline-flex items-center gap-1.5 rounded-full bg-white/5 ring-1 ring-amber-400/40 px-4 py-2 text-sm font-semibold text-amber-400 hover:bg-white/10 transition">
                        ...
                        @if ($lockedEnrollments->isNotEmpty())
                            <div id="locked-students" class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-red-500/15 via-gray-900 to-gray-900 ring-1 ring-red-400/30 p-6">
                                ...
                                <div class="relative">
                                    <p class="text-xs font-bold uppercase tracking-widest text-red-400">{{ __('Locked') }}</p>
                                    <p class="mt-2 text-4xl font-extrabold text-red-400">{{ $lockedEnrollments->count() }}</p>
                                    <p class="mt-1 text-sm text-gray-300">{{ trans_choice('{1} student currently locked out|[2,*] :count students currently locked out', $lockedEnrollments->count(), ['count' => $lockedEnrollments->count()]) }}</p>
                                    <button type="button" x-data x-on:click="$dispatch('open-modal', 'locked-students-modal')" class="mt-4 inline-flex items-center gap-1.5 rounded-full bg-white/5 ring-1 ring-red-400/40 px-4 py-2 text-sm font-semibold text-red-400 hover:bg-white/10 transition">
                                        {{ __('Click to view names') }}
                                        <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="{{ $arrowRightIconPath }}" /></svg>
                                    </button>
                                </div>
                            ...
                            <div class="max-h-96 overflow-y-auto divide-y divide-gray-100">
                                @foreach ($upcomingPayments as $enrollment)
                                    <div class="py-2.5 flex items-center justify-between gap-4 text-sm">
                                        ...
                                        <span class="text-xs text-gray-500 whitespace-nowrap">₦{{ number_format($enrollment->balance(), 2) }} · {{ optional($enrollment->due_date)->format('l, M j, Y') ?? '—' }}</span>
                                    </div>
                                @endforeach
                            </div>
                            <div class="mt-4 text-right">
            ...
            @if ($atRiskEnrollments->isNotEmpty())
                ...
                @endphp
                <div id="at-risk-students" class="bg-white shadow-sm ring-1 ring-gray-200 rounded-xl overflow-hidden mt-6">
                    <div class="relative overflow-hidden bg-black p-6 sm:p-8">
                        <svg class="pointer-events-none absolute -right-8 -top-8 h-48 w-48 text-red-500/10" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="0.75"><path stroke-linecap="round" stroke-linejoin="round" d="{{ $warningTriangleIconPath }}" /></svg>
                        ...
                        <div class="relative flex flex-wrap items-center justify-between gap-4">
                            <div class="flex items-center gap-4">
                                ...
                                <h3 class="text-xl font-bold text-white">{{ __('At-Risk Students') }}</h3>
                            </div>
                            <span class="inline-flex items-center gap-2 rounded-full bg-red-500/15 ring-1 ring-red-400/30 px-4 py-2 text-sm font-semibold text-red-400">
                        ...
                        <p class="relative text-sm text-gray-400 mt-4 max-w-3xl">{{ __('Active students who still owe money and are also showing early signs of dropping out (no training in a while) or defaulting (balance due soon) — a proactive watchlist for follow-up before it locks the enrollment on its own.') }}</p>
                    </div>
                                        ...
                                        @foreach ($atRiskEnrollments as $enrollment)
                                            ...
                                            <tr class="hover:bg-red-50/40 transition">
                                                <td class="py-3 pl-4 pr-4">
                                                    <div class="flex items-center gap-3">
                                                        <span class="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-red-100 text-xs font-bold text-red-700">{{ $riskInitials }}</span>
                            ...
                            >
                                ...
                                <div class="flex items-start gap-1.5 text-xs">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-semibold text-gray-700">{{ $studentService->processing_started_at?->format('l, M j, Y') ?? '—' }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-1.5 text-xs">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-semibold text-gray-700">{{ $studentService->expectedReadyAt()?->format('l, M j, Y') ?? '—' }}</p>
                                    </div>
                                </div>
            ...
            <div id="learners-permit-requests"></div>
            ...
            <div id="drivers-license-requests"></div>
