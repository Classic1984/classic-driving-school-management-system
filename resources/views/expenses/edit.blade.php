        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="flex items-center gap-4 mb-6 px-4 sm:px-0">
                ...
                <div class="min-w-0 flex-1">
                    <h3 class="text-2xl font-extrabold text-gray-900 truncate">{{ __('Edit Expense') }}</h3>
                    <p class="text-sm text-gray-500 truncate">{{ \App\Models\Expense::CATEGORIES[$expense->category] ?? $expense->category }}</p>
                </div>
            </div>
