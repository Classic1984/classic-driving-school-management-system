{{--
    Shared index page for both the Driver's License and Learner's Permit
    sections. Rendered by ServiceApplicationController::index() with
    $title/$service/$routePrefix varying per section - one file instead of
    two near-identical blade views.
--}}
<x-app-layout>
    <x-slot name="header">
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex flex-wrap items-start justify-between gap-4 mb-6">
                ...
                <a href="{{ route("{$routePrefix}.register") }}" class="inline-flex items-center gap-2 rounded-lg bg-amber-500 hover:bg-amber-600 px-4 py-2.5 text-sm font-bold text-black transition">
            ...
            <div class="bg-amber-50/40 ring-1 ring-amber-200 border-l-4 border-amber-500 rounded-xl p-6 mb-6">
                ...
                <form method="get" action="{{ route("{$routePrefix}.index") }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div>
                    ...
                    <div class="flex items-end gap-4">
                        ...
                        <a href="{{ route("{$routePrefix}.index") }}" class="text-sm text-gray-600 hover:underline">{{ __('Reset') }}</a>
                    </div>
                </form>
            </div>
