    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-4">
            ...
            @elseif (session('status') === 'quotation-whatsapp-failed')
                <p class="print-hidden text-sm font-medium text-red-600">{{ __('Could not send the quotation via WhatsApp. Check the company phone number and WhatsApp settings.') }}</p>
            @endif
