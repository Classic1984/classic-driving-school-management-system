        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <form method="post" action="{{ route('corporate-invoices.store') }}" class="space-y-6">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <a href="{{ route('corporate-invoices.index') }}" class="inline-flex items-center gap-2 rounded-lg ring-1 ring-gray-300 hover:bg-gray-50 px-5 py-3 text-sm font-semibold text-gray-700 transition">
