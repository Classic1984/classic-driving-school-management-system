            ...
            <div class="bg-white shadow-sm ring-1 ring-gray-200 rounded-xl p-6">
                ...
                <dl class="divide-y divide-gray-100">
                    ...
                    <div class="py-3 grid grid-cols-3 gap-4 items-center">
                        ...
                        <dd class="text-sm text-gray-900 col-span-2">{{ optional($student->date_of_birth)->format('l, M j, Y') ?? '—' }}</dd>
                    </div>
                    <div class="py-3 grid grid-cols-3 gap-4 items-center">
                        <dt class="text-sm text-gray-500 flex items-center gap-2">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            @forelse ($student->attendances as $index => $attendance)
                                <tr>
                                    ...
                                    <td class="px-2 py-2 text-sm">{{ $attendance->date->format('l, M j, Y') }}</td>
