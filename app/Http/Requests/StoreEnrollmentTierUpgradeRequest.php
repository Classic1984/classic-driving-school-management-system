...
class StoreEnrollmentTierUpgradeRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        $eligibleCourseIds = $enrollment->canUpgradeTier() ? $enrollment->eligibleTierUpgrades()->pluck('id') : collect();
    ...
    {
        return [
            'course_id.in' => 'That programme is not a valid tier upgrade for this enrollment.',
        ];
    }
