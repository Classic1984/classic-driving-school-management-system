...
class DashboardController extends Controller
{
    public function index(Request $request): View
    {
        ...
        return view('dashboard', compact('stats', 'newStudentTotals', 'paymentTotals', 'outstandingPayments', 'trainingProgress', 'trainingStats', 'lockedEnrollments', 'serviceProcessing', 'upgradeAlerts', 'kpis', 'todaysOperations', 'revenueLeakage'));
    }
